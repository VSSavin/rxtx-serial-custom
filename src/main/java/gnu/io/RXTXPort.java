...
final public class RXTXPort extends SerialPort {
	...
	*/
    ...
    protected final static boolean debug_read = Boolean.parseBoolean(System.getProperty("rxtx.debug.read"));
    protected final static boolean debug_read_results = Boolean.parseBoolean(System.getProperty("rxtx.debug.read.results"));
    protected final static boolean debug_write = Boolean.parseBoolean(System.getProperty("rxtx.debug.write"));
    protected final static boolean debug_events = Boolean.parseBoolean(System.getProperty("rxtx.debug.events"));
    protected final static boolean debug_verbose = Boolean.parseBoolean(System.getProperty("rxtx.debug.verbose"));
...
//test off!!!				int result = readByte();
                int result = 0xFF;//test!!!
                if (debug_read_results)
